...
# Prefer Python 3.12+ (project uses 3.10+ type hints; macOS system python is often 3.9)
PYTHON=""
...
if [ -z "$PYTHON" ]; then
  echo "Python 3.10+ required. Install from https://www.python.org/downloads/ or: brew install python@3.12"
  exit 1
fi
